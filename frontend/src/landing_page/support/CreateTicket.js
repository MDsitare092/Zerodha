        ...
        <div className='container'>
            <div className='row p-5 mt-5 mb-5'>
             ...
             <div className='col-4 p-5 mt-2 mb-2'>
                <h1 className='fs-4 mb-4'><i class="fa-solid fa-circle-plus"></i>Account Opening</h1>
                <h5>
            ...
            <div className='col-4 p-5 mt-2 mb-2'>
                <h1 className='fs-4 mb-4'><i class="fa-solid fa-user"></i>Your Zerodha Zccount</h1>
                <h5>
            ...
            <div className='col-4 p-5 mt-2 mb-2'>
                <h1 className='fs-4 mb-4'><i class="fa-solid fa-chart-line"></i>Your Zerodha Account</h1>
                <h5>
            ...
            <div className='col-4 p-5 mt-2 mb-2'>
                <h1 className='fs-4 mb-4'><i class="fa-solid fa-wallet"></i>Funds</h1>
                <h5>
                   <a href='' style={{textDecoration:"none", lineHeight:"2.5"}}>Adding Fund</a> <br/>
            ...
            <div className='col-4 p-5 mt-2 mb-2'>
                <h1 className='fs-4 mb-4'><i class="fa-solid fa-circle-notch"></i>Console</h1>
                <h5>
            ...
            <div className='col-4 p-5 mt-2 mb-2'>
                <h1 className='fs-4 mb-4'><i class="fa-regular fa-circle"></i>Coin</h1>
                <h5>
                   ...
                   <a href='' style={{textDecoration:"none", lineHeight:"2.5"}}>Buying and Selling </a><br/>
                   <a href='' style={{textDecoration:"none", lineHeight:"2.5"}}>Starting and SIP</a> <br/>
