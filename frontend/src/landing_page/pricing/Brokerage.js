            ...
            <div className='row p-5 mt-5 text-center border-top'>
                <div className='col-8 p-4'>
                    ...
                    <ul style={{textAlign:"left",lineHeight:"2.5,", fontSize:"12px"}} className='text-muted'>
                        <li>Call & Trade and RMS auto-aquareoff: Additional charges of ₹50 + GST per order.</li>
                        <li>Digital contract notes will be sent via e-mail.</li>
                        <li>Physical copies of contract notes, if required, shall be charged ₹20 per contract not. Courier charges apply.</li>
