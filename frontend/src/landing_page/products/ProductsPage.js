...
function ProductPage() {
    return ( 
        <>
           ...
           ProductName="Kite Connect API" ProductDescription="Build powerful trading platforms and experiences with our super simple HTTP/JSON APIs. If you are a startup, build your investment app and showcase it to our clientbase" 
           tryDemo="" 
           learnMore=""
           />
           <LeftSection 
           ...
           appStore="" 
           />
           <p className='text-center mt-5 mb-5'>Want to know more about our technology stack? Check out the <a href='' className='text-decoration-none'>Zerodha.tech</a> blog.</p>
           <Universe/>
